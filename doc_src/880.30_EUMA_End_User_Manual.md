...
This API, containing only public data, requires no authentication. However, not public or highly sensitive data can be encrypted and a password will be required to decrypt it.
